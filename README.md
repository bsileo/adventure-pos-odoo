...
- `addons/` — Odoo modules (`adventure_base`, `adventure_pos`, optional `adventure_smartwaiver`, planned: inventory, customers, purchase, reports); third-party App Store modules: [addons/README.md](addons/README.md)
