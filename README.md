...
- `addons/` — Odoo modules (`adventure_base`, `adventure_pos`, `adventure_ai`, `adventure_ai_retail`, …); third-party App Store modules: [addons/README.md](addons/README.md). AI architecture: [docs/architecture/adventure-ai.md](docs/architecture/adventure-ai.md).
