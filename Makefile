...
# Load Tidewater Dive Shop seed into the current local/sandbox DB (non-destructive).
# Optional: make seed-tidewater RESET_SEED=1
seed-tidewater:
	bash ./scripts/seed-dev-db.sh --profile tidewater $(if $(RESET_SEED),--reset-seed,)
